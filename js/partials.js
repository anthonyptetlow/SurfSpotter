...
angular.module('surfspotter').run(['$templateCache', function($templateCache) {
  $templateCache.put('index.html',
    '<html ng-app=surfspotter><head><title>SurfSpotter</title><meta http-equiv=Content-Type content=text/html><meta charset=utf-8><meta name=viewport content="width=device-width, initial-scale=1"><meta name=description content="Get notifications or emails about your favorite surf spots when the surf is good."><meta name=author content="Anthony P Tetlow"><meta name=keywords content="surf report, surf forecast, surfing, surf notification"><link rel=stylesheet href=/styles/core.css><base href="/"></head><body class=body data-ng-controller="AuthController as Auth"><div data-navigation-bar></div><div data-notification></div><div class="container content" data-ui-view></div><div class=preload data-hide-on-load><div class=message><h1>SurfSpotter</h1><div class=spinner-wave><div></div><div></div><div></div><div></div><div></div></div></div></div></body><script>\n' +
