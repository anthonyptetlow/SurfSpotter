angular.module('surfspotter').run(['$templateCache', function($templateCache) {
  $templateCache.put('Home.html',
    '<div class=row><div class=col-md-6><h1>Currently In Pre-Beta</h1><p>I am currently experimenting with different sources of data for the forecast. So any of the forecast data may be incorrect or out of date.</p><p>Your account details will not be altered during this exerimental time but your favourite spots may be removed.</p></div></div>');
}]);

angular.module('surfspotter').run(['$templateCache', function($templateCache) {
  $templateCache.put('index.html',
    '<html ng-app=surfspotter><head><title>SurfSpotter</title><meta http-equiv=Content-Type content=text/html><meta charset=utf-8><meta name=viewport content="width=device-width, initial-scale=1"><meta name=description content="Get notifications or emails about your favourite surf spots when the surf is good."><meta name=author content="Anthony P Tetlow"><meta name=keywords content="surf report, surf forecast, surfing, surf notification"><link href="https://fonts.googleapis.com/css?family=Roboto|Roboto+Slab:400,700" rel=stylesheet type=text/css><link rel=stylesheet href=/styles/core.css><base href="/"></head><body class=body data-ng-controller="AuthController as Auth"><div data-navigation-bar></div><div data-notification></div><div class="container content" data-ui-view=content></div><div found-bug></div><div class=preload data-hide-on-load><div class=message><h1>SurfSpotter</h1><div class=spinner-wave><div></div><div></div><div></div><div></div><div></div></div></div></div></body><script>\n' +
